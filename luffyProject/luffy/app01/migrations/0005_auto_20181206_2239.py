# Generated by Django 2.1.3 on 2018-12-06 14:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app01', '0004_coupon_couponrecord'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(limit_choices_to=models.Q(_negated=True, course_type=2), on_delete=django.db.models.deletion.CASCADE, to='app01.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor', models.ForeignKey(blank=True, limit_choices_to={'role': 1}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='app01.Account', verbose_name='导师')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Homework')),
                ('mentor', models.ForeignKey(limit_choices_to={'role': 1}, on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to='app01.Account', verbose_name='导师')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_module', models.ForeignKey(limit_choices_to={'course_type': 2}, on_delete=django.db.models.deletion.CASCADE, to='app01.Course', verbose_name='学位模块')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse', verbose_name='报名课程记录')),
                ('mentor', models.ForeignKey(limit_choices_to={'role': 1}, on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to='app01.Account', verbose_name='导师')),
            ],
            options={
