...
class ClassList(models.Model):
    ...
    tutor = models.ForeignKey(verbose_name='班主任',on_delete=models.CASCADE, to='UserInfo', related_name='classes',limit_choices_to={"depart":1001})
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', on_delete=models.CASCADE, related_name='consultanter',
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo',on_delete=models.CASCADE, limit_choices_to={"depart_id__in":[1002,1003]})
...
class StudyRecord(models.Model):
    ...
    homework_note = models.CharField(verbose_name='作业评语', max_length=255, blank=True, null=True, default="")
...
class CustomerDistrbute(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to="UserInfo", on_delete=models.CASCADE, limit_choices_to={"depart_id": 1001})
